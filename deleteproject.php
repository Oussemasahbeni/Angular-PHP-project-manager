...
if (!isset($id)) {
    echo json_encode(['success' => 0, 'message' => 'Please provide the project ID.']);
    exit;
}

try {

    $fetch_post = "SELECT * FROM `projects` WHERE id=:id";
    ...
    if ($fetch_stmt->rowCount() > 0) :
        ...
        $delete_post = "DELETE FROM `projects` WHERE id=:id";
        ...
        echo json_encode(['success' => 0, 'message' => 'Invalid ID. No projects found by the ID.']);
        exit;
    endif;
